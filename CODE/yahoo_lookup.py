...
"""Look up vital stock data on Yahoo and save to new list."""
...
def lookup(tickers, list_items, stats = 'sd1l1c1dr1q'):
    '''Look up a few vital elements and return them as a dictionary.'''
...
def truncate(x, places):
    '''x: float or int
    return x as string, truncated to "places" places'''
